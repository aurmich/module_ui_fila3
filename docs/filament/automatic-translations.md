...
> **NOTA IMPORTANTE**: Questo documento è un riferimento specifico per il modulo UI. La documentazione completa sulle traduzioni automatiche si trova nel [modulo Lang](../../Lang/project_docs/automatic-translations.md).
...
- [Documentazione Completa sulle Traduzioni Automatiche](../../Lang/project_docs/automatic-translations.md)
- [Best Practices per i Componenti Filament](./component-methods-compatibility.md)
- [Convenzioni di Traduzione](../../Lang/project_docs/translation-conventions.md)

## Collegamenti tra versioni di automatic-translations.md
* [automatic-translations.md](../../../Lang/project_docs/automatic-translations.md)
