...
L'utilizzo di `declare(strict_types=1)` è **obbligatorio** in tutti i file PHP del modulo UI che contengono logica di business, in conformità con le [regole generali del progetto](../../Xot/project_docs/php-strict-types.md) e per garantire la compatibilità con PHPStan livello 10.
...
- [Regole Generali per strict_types](../../Xot/project_docs/php-strict-types.md)
- [Linee Guida PHPStan Livello 10](../../Xot/project_docs/PHPStan/LEVEL10_LINEE_GUIDA.md)
