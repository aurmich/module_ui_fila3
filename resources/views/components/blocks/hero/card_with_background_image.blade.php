{{-- Hero section con card e immagine di sfondo --}}
<div class="bg-white">
    <main>
        <div>
            <!-- Hero card -->
                ...
                <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
                        ...
                        <div class="relative px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
                            ...
                            <p class="mx-auto mt-6 max-w-lg text-center text-xl text-indigo-100 sm:max-w-3xl">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</p>
